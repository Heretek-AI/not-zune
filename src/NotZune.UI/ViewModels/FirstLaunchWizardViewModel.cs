...
public class FirstLaunchWizardViewModel : ViewModelBase
{
    ...
    {
        FirstLaunchStep.Welcome => "WELCOME TO NOT-ZUNE",
    ...
    public string StepSubtitle => CurrentStep switch
    {
        ...
        FirstLaunchStep.ChooseFolder => "Point Not-Zune at your music folder. New files are picked up automatically as your collection grows.",
