...
namespace NotZune.Infrastructure.Audio;
...
public class SoundEffectService : ISoundEffectService
{
    ...
    public SoundEffectService()
    {
        ...
        var candidate2 = Path.Combine(Directory.GetCurrentDirectory(), "src", "NotZune.UI", "Assets", "Zune", "Sounds");
    ...
    private void PlaySound(string filename)
    {
        ...
        try
        {
            ...
            if (!File.Exists(soundPath))
            {
                ...
                var alt = Path.Combine(current, "src", "NotZune.UI", "Assets", "Zune", "Sounds", filename);
