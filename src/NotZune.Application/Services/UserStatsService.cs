...
public class UserStatsService : IUserStatsService
{
    ...
    public async Task<ZuneProfile> GetProfileAsync()
    {
        ...
        return new ZuneProfile
        {
            ...
            AvatarUri = "avares://NotZune.UI/Assets/Zune/Branding/ZUNEUSER.PNG"
        };
    }
    ...
    public async Task<IReadOnlyList<ZuneBadge>> GetBadgesAsync()
    {
        ...
        return new List<ZuneBadge>
        {
            new()
            {
                ...
                Title = "Early Adopter",
                Description = "First to embrace the Not-Zune revolution.",
                Category = "Pioneer",
                IsUnlocked = true,
                UnlockedAtUtc = DateTime.UtcNow.AddDays(-10),
                IconUri = "avares://NotZune.UI/Assets/Zune/Social/PROFILE.BADGE.SEAL.PNG"
            },
            new()
            {
