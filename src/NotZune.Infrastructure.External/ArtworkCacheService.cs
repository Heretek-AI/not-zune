...
{
    private const string UserAgent = "NotZune/1.0 (contact@notzune.org)";
    ...
    public ArtworkCacheService(HttpMessageHandler? innerHandler = null, string? cacheDirectory = null, TimeSpan? rateLimitInterval = null)
    {
        CacheDirectory = cacheDirectory
            ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "NotZune", "cache", "artwork");
