...
public class CallbackOnUIThreadBimodalManaged_DONOTUSE : IDisposable
{
	...
	{
		_pUI = pUI;
		CallbackOnUIThreadBimodalUnmanaged_DONOTUSE* ptr = (CallbackOnUIThreadBimodalUnmanaged_DONOTUSE*)global::_003CModule_003E.@new(8u);
		CallbackOnUIThreadBimodalUnmanaged_DONOTUSE* pUnmanaged;
		try
		{
			pUnmanaged = ((ptr == null) ? null : global::_003CModule_003E.MicrosoftZuneLibrary_002ECallbackOnUIThreadBimodalUnmanaged_DONOTUSE_002E_007Bctor_007D(ptr, this));
		}
		catch
		{
			//try-fault
	...
	private unsafe void _0021CallbackOnUIThreadBimodalManaged_DONOTUSE()
	{
		...
		if (pUnmanaged != null)
		{
			CallbackOnUIThreadBimodalUnmanaged_DONOTUSE* ptr = pUnmanaged;
			global::_003CModule_003E.MicrosoftZuneLibrary_002ECallbackOnUIThreadBimodalUnmanaged_DONOTUSE_002E_007Bdtor_007D(ptr);
			global::_003CModule_003E.delete(ptr);
		}
	}
	...
	{
		global::_003CModule_003E.MicrosoftZuneLibrary_002ECallbackOnUIThreadBimodalUnmanaged_DONOTUSE_002ECallback(_pUnmanaged, id, (void*)pData, (INativeDeferredCallback*)pInterface.ToPointer());
	}
