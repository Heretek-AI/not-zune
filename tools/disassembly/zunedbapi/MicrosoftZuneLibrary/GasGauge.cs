...
public class GasGauge : IDisposable
{
	...
	public unsafe ulong Capacity
	{
		get
		{
			...
			if (p != null)
			{
				return (ulong)((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, long>)(int)(*(uint*)(*(int*)p + 28)))((nint)p);
			}
			return 0uL;
		}
	}
	...
	public unsafe long SpaceAvailable
	{
		get
		{
			...
			if (p != null)
			{
				return ((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, long>)(int)(*(uint*)(*(int*)p + 24)))((nint)p);
			}
			return 0L;
		}
	}
	...
	public unsafe long SpaceReserved
	{
		get
		{
			...
			if (p != null)
			{
				return ((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, long>)(int)(*(uint*)(*(int*)p + 20)))((nint)p);
			}
			return 0L;
		}
	}
	...
	internal unsafe GasGauge(IGasGauge* pGasGauge)
	{
		...
		try
		{
			...
			try
			{
				...
				GasGaugeMediator* ptr = (GasGaugeMediator*)global::_003CModule_003E.@new(16u);
				GasGaugeMediator* lp;
				try
				{
					lp = ((ptr == null) ? null : global::_003CModule_003E.GasGaugeMediator_002E_007Bctor_007D(ptr, this, pGasGauge));
				}
				catch
				{
					//try-fault
	...
	private unsafe void _007EGasGauge()
	{
		...
		if (p != null)
		{
			global::_003CModule_003E.GasGaugeMediator_002EShutdown(p);
		}
	...
	public unsafe long GetSpaceUsedByCategory(ESyncCategory syncCategory)
	{
		...
		if (p != null)
		{
			return ((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, ESyncCategory, long>)(int)(*(uint*)(*(int*)p + 16)))((nint)p, syncCategory);
		}
		return 0L;
	}
