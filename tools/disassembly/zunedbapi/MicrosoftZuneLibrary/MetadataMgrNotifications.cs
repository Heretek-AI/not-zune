...
public class MetadataMgrNotifications : IDisposable
{
	...
	{
		NativeMetadataNotifications* ptr = (NativeMetadataNotifications*)global::_003CModule_003E.@new(12u);
		NativeMetadataNotifications* ptr2;
		try
		{
			ptr2 = ((ptr == null) ? null : global::_003CModule_003E.MicrosoftZuneLibrary_002ENativeMetadataNotifications_002E_007Bctor_007D(ptr, this));
		}
		catch
		{
			//try-fault
		...
		Unsafe.SkipInit(out IMetadataChangeNotify* ptr3);
		if (ptr2 == null || ((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, _GUID*, void**, int>)(int)(*(uint*)(int)(*(uint*)ptr2)))((nint)ptr2, (_GUID*)Unsafe.AsPointer(ref global::_003CModule_003E._GUID_d67cdf64_5ea9_44ea_bf5c_29a422f4c23f), (void**)(&ptr3)) < 0)
		{
			return;
		}
		fixed (uint* ptr4 = &m_AdviseCookie)
		{
			try
			{
