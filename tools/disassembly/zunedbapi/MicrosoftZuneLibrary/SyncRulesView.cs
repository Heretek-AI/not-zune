...
public class SyncRulesView : IDisposable
{
	...
	public unsafe int Count
	{
		get
		{
			...
			if (p != null)
			{
				return (int)((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, uint>)(int)(*(uint*)(*(int*)p + 20)))((nint)p);
			}
			return 0;
		}
	}
		...
		try
		{
			...
			try
			{
				...
				if (pSyncRulesView != null)
				{
					...
					ISyncRulesView* p = m_spSyncRulesView.p;
					if (((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, IGasGauge**, int>)(int)(*(uint*)(*(int*)p + 32)))((nint)p, &ptr) >= 0)
					{
				...
				SyncRulesViewMediator* ptr2 = (SyncRulesViewMediator*)global::_003CModule_003E.@new(16u);
				SyncRulesViewMediator* lp;
				try
				{
					lp = ((ptr2 == null) ? null : global::_003CModule_003E.SyncRulesViewMediator_002E_007Bctor_007D(ptr2, this, pSyncRulesView));
				}
				catch
				{
					//try-fault
	...
	private unsafe void _007ESyncRulesView()
	{
		...
		if (p != null)
		{
			global::_003CModule_003E.SyncRulesViewMediator_002EShutdown(p);
			m_spSyncRulesViewMediator.Release();
		}
		ISyncRulesView* p2 = m_spSyncRulesView.p;
		if (p2 != null)
		{
			((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, void>)(int)(*(uint*)(*(int*)p2 + 16)))((nint)p2);
	...
	public unsafe SyncRuleDetails GetItem(int index)
	{
		...
		ISyncRulesView* p = m_spSyncRulesView.p;
		Unsafe.SkipInit(out SSyncRuleDetails sSyncRuleDetails);
		if (p != null && ((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, uint, SSyncRuleDetails*, int>)(int)(*(uint*)(*(int*)p + 24)))((nint)p, (uint)index, &sSyncRuleDetails) >= 0)
		{
	...
	public unsafe void UpdateItem(int index, [MarshalAs(UnmanagedType.U1)] bool included)
	{
		...
		if (p != null)
		{
			((delegate* unmanaged[Thiscall, Thiscall]<IntPtr, uint, byte, int>)(int)(*(uint*)(*(int*)p + 28)))((nint)p, (uint)index, included ? ((byte)1) : ((byte)0));
		}
	}
