...
public class InteropNotifications : IDisposable
{
	...
	{
		NativeInteropNotifications* ptr = (NativeInteropNotifications*)global::_003CModule_003E.@new(12u);
		...
		Unsafe.SkipInit(out IInteropNotify* ptr3);
		if (ptr2 == null || ((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, _GUID*, void**, int>)(int)(*(uint*)(int)(*(uint*)ptr2)))((nint)ptr2, (_GUID*)Unsafe.AsPointer(ref global::_003CModule_003E._GUID_3fb2d757_8ddb_46a9_9dd2_3424e2903e46), (void**)(&ptr3)) < 0)
		{
			return;
		}
