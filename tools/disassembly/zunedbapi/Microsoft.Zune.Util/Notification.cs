...
public class Notification
{
	public static void BroadcastNowPlaying(EMediaTypes MediaType, string AlbumName, string ArtistName, string TrackTitle, int TrackNumber, Guid ZuneMediaId)
	{
		...
		case EMediaTypes.eMediaTypeVideo:
			...
			goto default;
		default:
			global::_003CModule_003E.Microsoft_002EZune_002EUtil_002E_003FA0x7bb9ee51_002ENotifyInstantMessenger(AlbumName, ArtistName, TrackTitle, TrackNumber, ZuneMediaId);
			break;
	...
	public static void ResetNowPlaying()
	{
		if (ClientConfiguration.Playback.NotifyIMClient)
		{
			global::_003CModule_003E.Microsoft_002EZune_002EUtil_002E_003FA0x7bb9ee51_002EResetInstantMessenger();
		}
	}
}
