...
public class ThumbBar : IDisposable
{
	...
	public unsafe int CreateButton(out ThumbBarButton button)
	{
		...
		Unsafe.SkipInit(out CComPtrNtv_003CIThumbBarButton_003E cComPtrNtv_003CIThumbBarButton_003E);
		*(int*)(&cComPtrNtv_003CIThumbBarButton_003E) = 0;
		try
		{
			IThumbBar* p = m_spThumbBar.p;
			((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, IThumbBarButton**, int>)(int)(*(uint*)(*(int*)p + 12)))((nint)p, (IThumbBarButton**)(&cComPtrNtv_003CIThumbBarButton_003E));
			button = new ThumbBarButton((IThumbBarButton*)(int)(*(uint*)(&cComPtrNtv_003CIThumbBarButton_003E)));
		}
		catch
		{
			//try-fault
	...
	public unsafe int UpdateThumbBar()
	{
		...
		return ((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, int>)(int)(*(uint*)(*(int*)p + 16)))((nint)p);
	}
