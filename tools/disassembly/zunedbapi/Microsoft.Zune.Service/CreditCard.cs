									...
									try
									{
										...
										try
										{
											...
											*(short*)(&stValue) = 0;
											...
											Unsafe.SkipInit(out ECreditCardType creditCardType);
											if (((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, IAddress**, ECreditCardType*, ushort**, ushort**, ushort**, ushort**, ushort**, ushort**, ushort**, ushort**, _SYSTEMTIME*, int>)(int)(*(uint*)(*(int*)pAddress + 16)))((nint)pAddress, (IAddress**)(&cComPtrNtv_003CIAddress_003E), &creditCardType, (ushort**)(&wBSTRString), (ushort**)(&wBSTRString2), (ushort**)(&wBSTRString3), (ushort**)(&wBSTRString4), (ushort**)(&wBSTRString5), (ushort**)(&wBSTRString6), (ushort**)(&wBSTRString7), (ushort**)(&wBSTRString8), &stValue) >= 0)
											{
												m_address = new Address((IAddress*)(int)(*(uint*)(&cComPtrNtv_003CIAddress_003E)));
												m_creditCardType = (CreditCardType)creditCardType;
												m_accountHolderName = new string((char*)(int)(*(uint*)(&wBSTRString)));
												m_accountNumber = new string((char*)(int)(*(uint*)(&wBSTRString2)));
												m_ccvNumber = new string((char*)(int)(*(uint*)(&wBSTRString3)));
												m_locale = new string((char*)(int)(*(uint*)(&wBSTRString4)));
												m_phoneNumber = new string((char*)(int)(*(uint*)(&wBSTRString5)));
												m_email = new string((char*)(int)(*(uint*)(&wBSTRString6)));
												m_contactFirstName = new string((char*)(int)(*(uint*)(&wBSTRString7)));
												m_contactLastName = new string((char*)(int)(*(uint*)(&wBSTRString8)));
												DateTime expirationDate = global::_003CModule_003E.SystemTimeToDateTime(stValue);
												m_expirationDate = expirationDate;
												m_parentCreditCard = ((delegate* unmanaged[Stdcall, Stdcall]<IntPtr, byte>)(int)(*(uint*)(*(int*)pAddress + 24)))((nint)pAddress) != 0;
											}
										}
										catch
										{
										...
										global::_003CModule_003E.WString_002E_007Bdtor_007D((WString*)(&wBSTRString8));
									}
									catch
									{
										//try-fault
