...
public class SettingCategories
{
	...
	public static Category PurchaseHistory
	{
		get
		{
			...
			{
				_purchaseHistory = new Category(StringId.IDS_BILLING_PURCHASE_HISTORY_HEADER, "res://ZuneShellResources!ManagementPurchases.uix", allowScrolling: false);
			}
	...
	public static Category RentalHistory
	{
		get
		{
			...
			{
				_rentalHistory = new Category(StringId.IDS_BILLING_RENTAL_HISTORY_HEADER, "res://ZuneShellResources!ManagementRentals.uix", allowScrolling: false);
			}
	...
	public static Category Metadata
	{
		get
		{
			if (_metadata == null)
			{
				StringId titleID = (FeatureEnablement.IsFeatureEnabled((Features)5) ? StringId.IDS_METADATA_AND_RATINGS_MENU_ITEM : StringId.IDS_METADATA_MENU_ITEM);
				_metadata = new Category(titleID, "res://ZuneShellResources!ManagementMetadata.uix");
			}
			return _metadata;
		}
	}
	...
	public static Category SubscriptionHistory
	{
		get
		{
			...
			{
				_subscriptionHistory = new Category(StringId.IDS_BILLING_DOWNLOAD_HISTORY_HEADER, "res://ZuneShellResources!ManagementSubscription.uix", allowScrolling: false);
			}
	...
	public static Category SyncGroups
	{
		get
		{
			if (_syncGroups == null)
			{
				_syncGroups = new Category(StringId.IDS_SYNC_GROUPS_SETTINGS_HEADER, "res://ZuneShellResources!DeviceSyncGroups.uix#SyncGroups", allowScrolling: false);
			}
			return _syncGroups;
		}
	}
	...
	public static Category SyncOptions
	{
		get
		{
			...
			{
				_syncOptions = new Category(StringId.IDS_SYNC_OPTIONS_HEADER, "res://ZuneShellResources!DeviceSyncOptions.uix#Default", allowScrolling: false);
			}
			return _syncOptions;
		}
	}
