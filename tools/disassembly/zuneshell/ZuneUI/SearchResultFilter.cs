...
public class SearchResultFilter
{
	...
	private static SearchResultFilterCommand CreateSearchResultFilterCommand(string description, SearchResultFilterType type)
	{
		return new SearchResultFilterCommand((ModelItem)(object)Search.Instance, description, type);
	}
}
