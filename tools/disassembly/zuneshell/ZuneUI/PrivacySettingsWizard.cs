...
public class PrivacySettingsWizard : AccountManagementWizard
{
	...
	{
		_editPrivacyInfoStep = new EditPrivacyInfoStep(this, base.State, parentAccount: false, PrivacyInfoSettings.None);
		...
		_errorStep = new AccountManagementErrorPage(this, Shell.LoadString(StringId.IDS_ACCOUNT_PRIVACY_UPDATE_ERROR_TITLE), Shell.LoadString(StringId.IDS_ACCOUNT_PRIVACY_UPDATE_ERROR_DESC));
	...
	protected override void OnAsyncCommitCompleted(bool success)
	{
		...
		_finishStep.ClosingMessage = Shell.LoadString(StringId.IDS_ACCOUNT_PRIVACY_UPDATE_SUCCESS_DESC);
		if (success)
		{
